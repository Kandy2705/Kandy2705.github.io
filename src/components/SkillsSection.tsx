                  ...
                  {items
                    ...
                    .map((skill) => {
                      ...
                      return (
                        <span
                          key={skill.id}
                          className="inline-flex items-center gap-2 rounded-xl border border-white/[.07] bg-white/[.025] px-3.5 py-2.5 text-sm text-white/68 transition duration-300 hover:-translate-y-0.5 hover:border-pink-300/25 hover:bg-pink-500/[.06] hover:text-pink-100"
                        >
